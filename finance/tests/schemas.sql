...
CREATE TABLE stocks.cashflow (
    ...
    effect_of_exchange_rate_changes flooat NULL,
    change_in_accrued_expense flooat NULL,
    change_in_tax_payable flooat NULL,
    change_in_income_tax_payable flooat NULL,
    amortization_cash_flow flooat NULL,
    amortization_of_intangibles flooat NULL,
    depreciation flooat NULL,
