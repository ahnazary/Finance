...
tickers_list = schedule_jobs.get_tickers_batch_backfill(
    table_name="balance_sheet", engine=schedule_jobs.engine, frequency="quarterly"
)
...
table_columns = ticker_interface.get_columns_names(table_name="balance_sheet")
...
ticker_interface.flush_records(table_name="balance_sheet", records=flattened_records)
